...
python neural_sentiment_classifier.py --model DAN --word_vecs_path data/glove.6B.300d-relativized.txt --train_path train.txt --dev_path dev.txt --blind_test_path test.txt
"""
